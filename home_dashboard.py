...
.filter-row input{flex:0 0 30%;padding:10px;border-radius:8px;border:1px solid #ccd;font-size:16px;text-align:center}
.filter-row button{border:none;border-radius:8px;font-weight:700;font-size:11px;color:#fff;cursor:pointer}
.btn-search{flex:0 0 34%;background:#00609C}
.btn-today{flex:1;background:#26a34a}
