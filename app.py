...
<html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Cashier</title>
...
<div class="topbar"><h1>OMEGA PURIFIED ICE☁️</h1><div><span class="staff">{{ staff_name }} ({{ staff_position }})</span><button class="logout" onclick="logout()" style="font-size:12px;color:#c0392b;background:none;border:none">Logout</button></div></div>
<div class="card">
