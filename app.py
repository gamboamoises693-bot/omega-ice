...
<a href="/customer/{{ reseller_id }}/advance-order" style="padding:8px 12px;border-radius:20px;border:1px solid #fcd9a8;background:#fff7ed;color:#c2410c;font-size:11px;text-decoration:none;font-weight:600">🎉 Book an Event</a>
</div>
