...
<body>
<div class="cloud-badge">☁️ Cloud v8.1 INSTANT LOGIN FIXED LIVE</div>
<div class="topbar"><h1>OMEGA ICE - Cashier v8.1 ☁️</h1><div><span class="staff">{{ staff_name }} ({{ staff_position }})</span><button class="logout" onclick="logout()" style="font-size:12px;color:#c0392b;background:none;border:none">Logout</button></div></div>
<div class="card">
...
@app.route("/health")
def health(): return jsonify({"ok":True,"firebase":FIREBASE_URL,"version":"v8.1 INSTANT LOGIN FIXED"})
