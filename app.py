...
<p style="font-size:12px;color:#888;text-align:center;margin-top:14px;border-top:1px solid #eee;padding-top:14px">Nakalimutan ang password?<br><button class="link-btn" onclick="openForgotModal()">🔑 I-reset gamit ang OTP (SMS)</button></p>
</div>
...
<div class="modal-overlay" id="forgotModal">
  <div class="modal-box">
    <div id="forgotStep1">
      ...
      <p class="step-hint">Ilagay ang registered phone number mo. Padadalhan ka ng SMS na may 6-digit na OTP code.</p>
      ...
      <div class="modal-actions">
        ...
        <button class="modal-btn-primary" onclick="requestForgotOtp()">Padalhan ako ng OTP</button>
      </div>
    </div>
    <div id="forgotStep2" style="display:none">
      <h3>🔑 Ilagay ang OTP</h3>
      <p class="step-hint">Ilagay ang 6-digit OTP na natanggap mo sa SMS, at ang bagong password mo.</p>
...
async function requestForgotOtp(){
  ...
  st.textContent='Pinapadala ang OTP...'; st.className='status';
  try{
    ...
    if(data.ok){
      ...
      document.getElementById('forgotStatus2').textContent = data.sms_sent===false ? (data.message||'OTP generated - tanungin ang staff.') : 'Naipadala na ang OTP sa phone mo!';
...
<a href="/customer/{{ reseller_id }}/advance-order" class="action-btn action-btn-warn action-btn-wide"><span class="action-btn-icon">🎉</span>Book an Event</a>
</div>
