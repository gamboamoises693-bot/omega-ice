...
from modules.home_dashboard import home_bp
...
# nothing's there yet (see get_reward_catalog()). Points math (Sept 21):
# reseller's real all-time margin was 27.1%, so giving away a free bag
# costs ~72.9% of its price in real production cost. These thresholds use
# a 4x-price multiplier, which leaves the shop a ~49% safety buffer above
# break-even on every redemption (covers normal margin fluctuation from
# electricity/consumables cost swings) - ISESMO can retune these anytime
# from /admin/rewards without a code change.
DEFAULT_REWARD_CATALOG = {
    "reward_1kg": {"label": "Libreng 1Kg Ice", "kg_size": "1Kg", "quantity": 1, "points_required": 40},
    "reward_5kg": {"label": "Libreng 5Kg Ice", "kg_size": "5Kg", "quantity": 1, "points_required": 200},
    "reward_10kg": {"label": "Libreng 10Kg Ice", "kg_size": "10Kg", "quantity": 1, "points_required": 400},
    "reward_25kg": {"label": "Libreng 25Kg Ice", "kg_size": "25Kg", "quantity": 1, "points_required": 1000},
}
