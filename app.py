...
<div class="card"><div style="overflow-x:auto"><table><thead><tr><th>Store</th><th>Phone / Login</th><th>OTP / Status</th><th>Action</th></tr></thead><tbody id="tbody"><tr><td colspan=4 style="text-align:center;padding:20px;color:#999">Loading customers... Please wait</td></tr></tbody></table></div></div>
...
async function loadCustomers(){
  try{
    ...
    if(!rows.length){document.getElementById('tbody').innerHTML='<tr><td colspan=4 style="text-align:center;padding:20px;color:#888">No customers yet.<br><small>Records safe in Firebase - check Firebase console if empty</small></td></tr>'; return;}
